...
>
  <head>
    ...
    <link
      href="./jobseeker_login_files/akshs-supercool-site.webflow.f8602ada2.css"
      rel="stylesheet"
      type="text/css"
    />
    ...
    />
    <script
      src="./jobseeker_login_files/webfont.js.download"
      type="text/javascript"
    ></script>
    <link rel="stylesheet" href="./jobseeker_login_files/css" media="all" />
  ...
  <?php include './php/header.php';?>
    <div class="utility-page-wrap">
      <div class="utility-page-content w-password-page w-form">
        <form
          action="./php/jobseeker_login.php"
          method="post"
          id="email-form"
          name="email-form"
        ...
        >
          <img
            src="./jobseeker_login_files/utility-lock.ae54711958.svg"
            alt=""
            width="262"
            class="image-2"
          />
    ...
    <script
      src="./jobseeker_login_files/jquery-3.5.1.min.dc5e7f18c8.js.download"
      type="text/javascript"
      integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0="
      crossorigin="anonymous"
    ></script>
    <script
      src="./jobseeker_login_files/webflow.8ec0ab91f.js.download"
      type="text/javascript"
    ></script>
    <!--[if lte IE 9
