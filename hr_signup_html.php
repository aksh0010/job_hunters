...
<html
  ...
  class="w-mod-js wf-greatvibes-n4-active wf-inconsolata-n4-active wf-inconsolata-n7-active wf-exo-i1-active wf-exo-i4-active wf-exo-i8-active wf-exo-i2-active wf-exo-i6-active wf-exo-i3-active wf-exo-i5-active wf-exo-i9-active wf-exo-i7-active wf-exo-n3-active wf-exo-n1-active wf-exo-n6-active wf-exo-n9-active wf-exo-n5-active wf-exo-n8-active wf-exo-n2-active wf-exo-n7-active wf-exo-n4-active wf-merriweather-n3-active wf-merriweather-n7-active wf-merriweather-i7-active wf-merriweather-n9-active wf-merriweather-i9-active wf-merriweather-i3-active wf-merriweather-i4-active wf-merriweather-n4-active wf-active"
>
  <head>
    ...
    <link
      href="./hr_signup_files/akshs-supercool-site.webflow.d25e70f72.css"
      rel="stylesheet"
      type="text/css"
    />
    ...
    />
    <script
      src="./hr_signup_files/webfont.js.download"
      type="text/javascript"
    ></script>
    <link rel="stylesheet" href="./hr_signup_files/css" media="all" />
  ...
  <body data-new-gr-c-s-check-loaded="14.1103.0" data-gr-ext-installed="">
    ...
    <div class="utility-page-wrap">
      ...
      <div class="utility-page-content w-password-page w-form">
        ...
        >
          <img
            src="./hr_signup_files/utility-lock.ae54711958.svg"
            alt=""
            width="37"
            class="image-2"
          />
          <h2>Signup</h2>
          <label for="field" class="w-password-page">HR Signup forum</label
          ><input
            type="text"
            class="w-input"
            maxlength="256"
    ...
    <script
      src="./hr_signup_files/jquery-3.5.1.min.dc5e7f18c8.js.download"
      type="text/javascript"
      integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0="
      crossorigin="anonymous"
    ></script>
    <script
      src="./hr_signup_files/webflow.8ec0ab91f.js.download"
      type="text/javascript"
    ></script>
    <!--[if lte IE 9
